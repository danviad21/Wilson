...
import com.odavid.projects.OAuth2.model.dao.IUsuarioDao;
...
public class IUsuarioService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(usuario == null) {
			logger.error("ERROR USERDETAILS: Usuario " +username+ " no existe en el sistema");
			throw new  UsernameNotFoundException("ERROR USERDETAILS: Usuario " +username+ " no existe en el sistema");
		}
